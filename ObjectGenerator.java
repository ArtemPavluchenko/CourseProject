...
class LaptopGenerator implements GeneratorLaptop {
	...
	public String generateBattery() {
		...
		int capacity = bat*10;
		battery = battery+" "+String.valueOf(battery)+" mAh";
		return battery;
	}
	...
	public String toString() {
		return "Laptop" +
				...
				", batares=" + Arrays.toString(batares) +
				", manufacturedCompany=" + Arrays.toString(manufacturedCompany) +
				", laptopsName=" + Arrays.toString(laptopsName) +
				", cpuNames=" + Arrays.toString(cpuNames) +
				'}';
	}
}
